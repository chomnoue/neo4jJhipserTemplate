...
neo4jjhipsertemplateApp.controller('MainController', ['$scope',
    function ($scope) {
    }]);

neo4jjhipsertemplateApp.controller('AdminController', ['$scope',
    function ($scope) {
    }]);

neo4jjhipsertemplateApp.controller('LanguageController', ['$scope', '$translate',
...
neo4jjhipsertemplateApp.controller('MenuController', ['$scope',
    function ($scope) {
    }]);

neo4jjhipsertemplateApp.controller('LoginController', ['$scope', '$location', 'AuthenticationSharedService',
...
neo4jjhipsertemplateApp.controller('LogoutController', ['$location', 'AuthenticationSharedService',
    function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    }]);

neo4jjhipsertemplateApp.controller('SettingsController', ['$scope', 'Account',
...
neo4jjhipsertemplateApp.controller('RegisterController', ['$scope', '$translate', 'Register',
...
neo4jjhipsertemplateApp.controller('ActivationController', ['$scope', '$routeParams', 'Activate',
...
neo4jjhipsertemplateApp.controller('PasswordController', ['$scope', 'Password',
...
neo4jjhipsertemplateApp.controller('SessionsController', ['$scope', 'resolvedSessions', 'Sessions',
 ...
 neo4jjhipsertemplateApp.controller('TrackerController', ['$scope',
    function ($scope) {
...
neo4jjhipsertemplateApp.controller('MetricsController', ['$scope', 'MetricsService', 'HealthCheckService', 'ThreadDumpService',
...
neo4jjhipsertemplateApp.controller('LogsController', ['$scope', 'resolvedLogs', 'LogsService',
...
neo4jjhipsertemplateApp.controller('AuditsController', ['$scope', '$translate', '$filter', 'AuditsService',
