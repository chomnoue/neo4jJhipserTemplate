package com.chomnoue.jhipster.neo4j.template.config;
...
import com.chomnoue.jhipster.neo4j.template.web.filter.CachingHttpHeadersFilter;
import com.chomnoue.jhipster.neo4j.template.web.filter.StaticResourcesProductionFilter;
import com.chomnoue.jhipster.neo4j.template.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "com.chomnoue.jhipster.neo4j.template.web.websocket");
